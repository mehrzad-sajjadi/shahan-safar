<template>
    <div class="w-[80%] absolute top-[80%] left-1/2 -translate-x-1/2  bg-white border border-black p-4 rounded-lg shadow-lg">
        ...
        <div class="flex justify-center min-h-min items-center">
            ...
            <PersoNums />
            <button @click="target=!target">Modal</button>
            <button class="h-full bg-amber-400">جستجو</button>
        </div>
    </div>
    <Teleport to="body">
        <ModalNums
...
import PersoNums from './PersoNums.vue';
